...
namespace LuaCreature
{
    ...
    */
     ...
     */
    int GetUnitFlags(Eluna* E, Creature* creature)
    {
        E->Push(creature->GetUInt32Value(UNIT_FIELD_FLAGS));
        return 1;
    }
     ...
     */
    int GetUnitFlagsTwo(Eluna* E, Creature* creature)
    {
        E->Push(creature->GetUInt32Value(UNIT_FIELD_FLAGS_2));
        return 1;
    }
     ...
     */
    int SetUnitFlags(Eluna* E, Creature* creature)
    {
        uint32 flags = E->CHECKVAL<uint32>(2);
     ...
     */
    int SetUnitFlagsTwo(Eluna* E, Creature* creature)
    {
        uint32 flags = E->CHECKVAL<uint32>(2);
